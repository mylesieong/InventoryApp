...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if (gender == null || !InventoryContract.InventoryEntry.isValidGender(gender)) {
            throw new IllegalArgumentException("Pet requires valid gender");
        }

        Integer weight = values.getAsInteger(InventoryContract.InventoryEntry.COLUMN_PET_WEIGHT);
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        if (values.containsKey(InventoryContract.InventoryEntry.COLUMN_PET_NAME)) {
            String name = values.getAsString(InventoryContract.InventoryEntry.COLUMN_PET_NAME);
            if (name == null) {
                throw new IllegalArgumentException("Pet requires a name");
            }
        ...
        if (values.containsKey(InventoryContract.InventoryEntry.COLUMN_PET_GENDER)) {
            Integer gender = values.getAsInteger(InventoryContract.InventoryEntry.COLUMN_PET_GENDER);
            if (gender == null || !InventoryContract.InventoryEntry.isValidGender(gender)) {
                throw new IllegalArgumentException("Pet requires valid gender");
            }
        }
